...
{
    [TestClass]
    public class UnitTestListing19AgregateExceptions
    {
        [TestMethod]
        public void TestMethod1()
        {
            ...
            Task task3 = new Task(() =>
            {
                Trace.WriteLine("Hello from Task 3");
            });
            // start the tasks
            ...
            catch (AggregateException ex)
            {
                ...
                {
                    Trace.WriteLine(String.Format("Exception type {0} from {1}", inner.GetType(), inner.Source));
                }
            }
