...
namespace EIPNET.EIP
{
    ...
    public class SessionInfo
    {
        ...
        /// <summary>
        /// See CIP Vol2_1.4.pdf, 3-3 COnnection Manager Object
        /// </summary>
        /// <param name="ConnectionSerialNumber"></param>
        /// <param name="CIPTimeoutMs"></param>
        /// <param name="T2O_ConnectionId"></param>
		...
		{
			return SendRRData(AddressItem, DataItem, null);
		}
#endif
#if MONO
		public EncapsReply SendRRData(CommonPacketItem AddressItem, CommonPacketItem DataItem, CommonPacketItem[] AdditionalItems)
#else
