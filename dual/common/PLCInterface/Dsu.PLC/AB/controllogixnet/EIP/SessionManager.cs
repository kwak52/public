...
namespace EIPNET.EIP
{
    ...
    {
#if MONO
		public static SessionInfo CreateAndRegister(string hostNameOrIp)
		{
			return CreateAndRegister(hostNameOrIp, 0xAF12, null);
		}
		
		public static SessionInfo CreateAndRegister(string hostNameOrIp, int port)
		{
			return CreateAndRegister(hostNameOrIp, port, null);
		}
#endif
#if MONO
		public static SessionInfo CreateAndRegister(string hostNameOrIp, int port, byte[] senderContext)
#else
        /// <summary>
