...
using Resources = Dsu.PLC.Resources;
...
namespace ControlLogixNET.LogixType
{
    ...
    /// </summary>
    internal static class LogixTagFactory
    {
#if MONO
        ...
        private static TemplateInfo ReadStructAttributes(ushort structureId, LogixProcessor processor)
        {
            ...
            ucmm.MessageRequest.Service = (byte)ControlNetService.GetAttributeList;    // 0x03;
            ...
            ucmm.MessageRequest.Service = (byte)ControlNetService.CIP_ReadData;   // 0x4C;
    ...
    /// </summary>
    internal sealed class LogixBOOL : LogixTag
    {
    ...
    /// </summary>
    internal sealed class LogixDINT : LogixTag
    {
    ...
    /// </summary>
    internal sealed class LogixINT : LogixTag
    {
    ...
    /// </summary>
    internal sealed class LogixSINT : LogixTag
    {
    ...
    /// </summary>
    internal sealed class LogixLINT : LogixTag
    {
    ...
    /// </summary>
    internal sealed class LogixREAL : LogixTag
    {
    ...
    internal class LogixUDT : LogixTag
    {
    ...
    /// </summary>
    internal sealed class LogixCONTROL : LogixUDT
    {
    ...
    /// </summary>
    internal sealed class LogixTIMER : LogixUDT
    {
    ...
    /// Represents a type of COUNTER in a Logix Processor
    /// </summary>
    internal sealed class LogixCOUNTER : LogixUDT
    {
    ...
    /// </summary>
    internal sealed class LogixSTRING : LogixUDT
    {
