...
namespace ControlLogixNET
{
    ...
    public sealed class LogixProcessor : IDevice
    {
        ...
        public static LogixProcessor TheInstance { get; private set; }
        /// <summary>
        ...
        public LogixProcessor(string HostNameOrIP, byte[] ProcessorPath, ushort port=0xAF12)        // 44818 port
        {
        ...
        public bool Connect()
        {
            ...
            {
                _initializing = true;
                _session = SessionManager.CreateAndRegister(_ipAddress, 0xAF12, null);// System.Text.ASCIIEncoding.ASCII.GetBytes("6DSYSTEM"));
        ...
        internal LogixTagGroup CreateTagGroup(string GroupName)
        {
        ...
        internal LogixTagGroup GetTagGroup(string GroupName)
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal List<LogixTagInfo> EnumerateTags()
        {
            return GetTagInfo();
        }
        ...
        internal LogixTagInfo GetTagInformation(string Address)
        {
        ...
        private List<LogixTagInfo> GetTagInfo()
        {
            ...
            ucmm.MessageRequest = new MR_Request();
            ucmm.MessageRequest.Service = 0x55;         // Get_Instance_Attribute_List(0x55) ?? pp. 40.
