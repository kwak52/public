...
namespace ControlLogixNET
{
    ...
    internal class LogixTagInfo
    {
        ...
        public CIPType CIPType => (EIPNET.CIP.CIPType) DataType;
        /// <summary>
        /// Gets the CIP data type for the tag, or the structure handle.  CIPType 으로 casting
        /// </summary>
