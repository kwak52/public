...
namespace SimpleOperations
{
    class Program
    {
        static void DoTest(LogixProcessor processor)
        {
            byte[] newIOI = IOI.BuildIOI("ARRAY3[1,1,1]");
            var x = newIOI;

            TestLogix.BuildLogixReadDataRequest(processor, new string[] { "ARRAY1[0]", "ARRAY3[1,1,1]", "ARRAY1[2]" });
        }
        /*
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            string hostNameOrIp = "192.168.0.104";
