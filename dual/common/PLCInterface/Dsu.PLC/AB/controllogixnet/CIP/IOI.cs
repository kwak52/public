...
namespace EIPNET.CIP
{
    ...
    /// </summary>
    internal static class IOI
    {
#if MONO
		public static int BuildIOIString(byte[] IOI, string address, int size)
		{
			return BuildIOIString(IOI, address, size, 0);
		}
#endif
#if MONO
		public static int BuildIOIString(byte[] IOI, string address, int size, int start)
#else
		...
		public static int BuildIOIArray(byte[] IOI, string address, int size)
		{
			return BuildIOIArray(IOI, address, size, 0);	
		}
		
#endif
		
#if MONO
		public static int BuildIOIArray(byte[] IOI, string address, int size, int start)
#else
