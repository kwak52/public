...
{
    internal class PLCConnection : IDisposable, INotifyPropertyChanged
    {
        ...
        public PLCConnection(String name, string ip = "127.0.0.1", ushort port = 102)
        {
            ...
            _configuration = new PLCConnectionConfiguration(name, ip, port);
        ...
        internal class DiagnosticData : IDisposable
        {
        ...
        #region VarTab
        internal class VarTabReadData : IDisposable
        {
            internal short ReqestID;
            internal PLCConnection myConn;
