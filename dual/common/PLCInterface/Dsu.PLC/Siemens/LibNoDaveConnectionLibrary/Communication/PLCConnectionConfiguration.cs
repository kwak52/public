...
{    
    ...
    /// </summary>
    internal class PLCConnectionConfiguration : INotifyPropertyChanged
    {
        ...
        public PLCConnectionConfiguration(String ConnectionName, string ip="127.0.0.1", ushort port = 102)
        {
            if (ConnectionName == "")
