...
namespace DotNetSiemensPLCToolBoxLibrary.Communication.LibNoDave
{
    ...
    internal class libnodave
    {
        ...
        */
        ...
        public static string daveStrS7onlineError()
        {
            ...
            switch (err)
            {
                ...
                case 207:
                    return "S7Online: Ger? bereits/noch nicht ge?fnet.";
                case 208:
                ...
                case 225:
                    return "S7Online: Die maximale Anzahl an Anmeldungen ist ?erschritten";
                case 226:
                    return "S7Online: Der Auftrag wurde abgebrochen";
                case 233:
                    return "S7Online: Ein Hilfsprogramm konnte nicht gestartet werden";
                case 234:
                    return "S7Online: Keine Autorisierung f? diese Funktion vorhanden";
                case 304:
        ...
        */
        ...
        internal class daveInterface : pseudoPointer
        {
        ...
        internal class daveConnection : pseudoPointer, IDaveConnection
        {
#if !IPHONE
        ...
        internal class PDU : pseudoPointer, IPDU
        {
#if !IPHONE
        ...
        internal class resultSet : pseudoPointer, IresultSet
        {
        ...
        public static void putBCD8at(byte[] b, int pos, int value)
        {
            ...
            //setze h?hstes bit == negativer wert!
            if (value >= 0)
            {
                b1 = (value % 100 / 10);
                b0 = value % 10;
