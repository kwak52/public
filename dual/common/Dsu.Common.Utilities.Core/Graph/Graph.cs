...
namespace Dsu.Common.Utilities.Graph
{
        ...
        where N : IEquatable<N>
    {
        ...
        {
            if (m_Nodes.Contains(node)) throw new ArgumentException("The specified node is already in the graph");
            m_Nodes.Add(node);
        }
        ...
        public void AddEdgeEx(N start, N end, E data)
        {
            ...
            m_Edges.Add(new Edge<N, E>(start, end, data));
        }
    
        public bool AddEdge(N start, N end, E data)
        {
            try
            {
                AddEdgeEx(start, end, data);
                return true;
            }
            catch (System.Exception ex)
            {
        ...
        public void Clear() { m_Nodes.Clear(); m_Edges.Clear(); }
