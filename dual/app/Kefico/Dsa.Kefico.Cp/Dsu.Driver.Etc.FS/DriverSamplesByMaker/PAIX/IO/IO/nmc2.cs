...
namespace Paix_MotionControler
{
    class NMC2
    {
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_OpenDeviceEx(short nNmcNo, long lWaitTime);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetParaLogicEx(short nNmcNo, short nAxisNo, out NMCPARALOGICEX pLogicEx);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetHomeSpeedAccDec(short nNmcNo, short nAxisNo, double dHomeSpeed0, double dStart0, double dAcc0, double dDec0, double dHomeSpeed1, double dStart1, double dAcc1, double dDec1,
